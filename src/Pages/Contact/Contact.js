        ...
        <div className='contact--us'>
            ...
            <div className='card2'>
                <div className='contact--usHeading'>
                    ...
                    <h3 className='contact--sub'>Want to get in touch? We'd love to hear from you. <br/> Here's how you
                        can
                        reach
                        us... </h3>
                </div>
                <div className='about--card'>
                    <div className='contact--card'>
                        ...
                        <div className='contactCard--details'>
                            ...
                            <h3 className='contactCard--address'>109 Circular Road Galle 80000 <br/> Sri Lanka</h3>
                        </div>
                    </div>
                    <div className='contact--card'>
                    ...
                    <div className='contact--card'>
                        ...
                        <div className='contactCard--details'>
                            ...
                            <h3 className='contactCard--address'>info.mubarakproducts@gmail.com</h3>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className='contact--form'>
                <div className="contact-wrap">
                    ...
                    <form action="src/Pages/Contact/Contact" className="contact-form">
                        <div>
                        ...
                        <div>
                            <div className="col-sm-6">
                                <div className="input-block">
                                    <input type="text" className="form-control-line-1" placeholder="First Name"/>
                                </div>
                                <div className="col">
                                    <div className="input-block">
                                        <input type="text" className="form-control-line-1" placeholder="Last Name"/>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-sm-12">
                                ...
                                <textarea rows="3" type="text" className="form-control-area"
            ...
            <div className='contact--available--outlets'>
                <div>
                    <h1 className='available--location-header'>Where to buy our Products</h1>
                    <h3 className='available--location-sub'>Hero S</h3>
                </div>
                <div className='product--Map'>
                    <div className='map'>
                        <iframe className='google--map'
                                src="https://www.google.com/maps/d/embed?mid=1Ac1m7yPtbgmxXk1LQhsvp-6OMwUICvQ&ehbc=2E312F"></iframe>
                    </div>
